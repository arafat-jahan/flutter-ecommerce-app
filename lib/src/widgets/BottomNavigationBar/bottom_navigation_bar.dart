...
import 'package:flutter_ecommerce_apps/src/widgets/BottomNavigationBar/bottom_curved_Painter.dart';

class CustomBottomNavigationBar extends StatefulWidget {
  final Function(int) onIconPressedCallback;
  const CustomBottomNavigationBar({Key? key, required this.onIconPressedCallback}) : super(key: key);
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar> with TickerProviderStateMixin {
  ...
  double _indexToPosition(int index) {
    // Calculate button positions based off of their index
  ...
  Widget _buildBackground() {
    final inCurve = Curves.elasticOut; // Use the predefined elastic out curve
    return CustomPaint(
